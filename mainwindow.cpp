...
MainWindow::MainWindow(QWidget *parent) : QMainWindow(parent), ui(new Ui::MainWindow) {
    ...
    // Disconnect any existing connections to the on_pushButton_5_clicked() slot
...
void MainWindow::loadStlFile(const QString& fileName)
{
    ...
    resetCamera(); // Added this line to reset the camera after loading the STL file
    updateRender(); // Update the render window to reflect the changes
